...
def create_launcher(): 
    ...
    for cluster_name in cluster_name_list:
        ...
        launcher_file.write(cluster_dict[cluster_name].launch_command + cluster_dict[cluster_name].qepath + 'pw.x -i ' + file_name.replace('.scf','.U.$U.scf')  + ' > ' + file_name.replace('.scf.in','.U.$U.scf.out')  + '\n') 
